...
class GVPTransCond(torch.nn.Module):
    ...
    def __init__(self, config):
        super().__init__()
        self.node_in_dim = tuple(config.model.node_in_dim)
        self.node_h_dim = tuple(config.model.node_h_dim)
        self.edge_in_dim = tuple(config.model.edge_in_dim)
        self.edge_h_dim = tuple(config.model.edge_in_dim)
